    ...
    const checkAuthCookie = () => {
      ...
      useEffect(() => {
        const checkData = async () => {
          if (checkAuthCookie()) {
            try {
              const response = await axios.get('https://linguityapi-djq5jpbe4a-et.a.run.app/home');
      ...
      const handlelogout = () => {
          axios.delete('https://linguityapi-djq5jpbe4a-et.a.run.app/logoutAdmin')
          .then((res) => {
              navigate('/login')
          })
      }
            ...
            <div class="row flex-nowrap ">
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            ...
                            <li>
                                <Link to='/article' data-bs-toggle="collapse" class="textSidebar nav-link px-0 align-middle">
                                    <i class="fs-4 bi-journal-check"></i> <span class="ms-1 d-none d-sm-inline">Data Artikel</span> </Link>
                ...
                <div class="col p-0 m-0">
                        <div className='textStyle d-flex align-items-center'>
                            ...
                            <span className='textLogoStyle mt-3'>Linguity</span>
                        </div>
                    <Outlet />
                </div>
            </div>
