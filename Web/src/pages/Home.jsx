...
export default function Home() {
  ...
  useEffect(() => {
      axios.get('https://linguityapi-djq5jpbe4a-et.a.run.app/countUser')
      .then((res) => {
          setCount (res.data)
      })
  })
  useEffect(() => {
    axios.get('https://linguityapi-djq5jpbe4a-et.a.run.app/listadmin')
      .then((res) => {
  ...
  const handleDelete =(id) => {
    axios.delete(`https://linguityapi-djq5jpbe4a-et.a.run.app/deleteadmin/${id}`)
    .then((res)=>{
        if(res.data.status === "Success")
