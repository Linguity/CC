...
export default function DataQuiz(){
    ...
    useEffect(() => {
        axios.get('https://linguityapi-djq5jpbe4a-et.a.run.app/listSpelling')
          .then((res) => {
      ...
      const handleDeleteSpelling =(id) => {
        axios.delete(`https://linguityapi-djq5jpbe4a-et.a.run.app/deleteSpelling/${id}`)
        .then((res)=>{
            if(res.data.status === "Success")
      ...
      useEffect(() => {
        axios.get('https://linguityapi-djq5jpbe4a-et.a.run.app/listPronunciation')
          .then((res) => {
              if(res.data.status === "Success"){
      ...
      const handleDeletePronunciation =(id) => {
        axios.delete(`https://linguityapi-djq5jpbe4a-et.a.run.app/deletePronunciation/${id}`)
        .then((res)=>{
            if(res.data.status === "Success")
            window.location.reload();
        })
