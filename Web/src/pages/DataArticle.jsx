...
export default function DataArticle(){
    ...
    useEffect(() => {
        axios.get('https://linguityapi-djq5jpbe4a-et.a.run.app/listArticle')
          .then((res) => {
      ...
      const handleDelete =(id) => {
        axios.delete(`https://linguityapi-djq5jpbe4a-et.a.run.app/deleteArtikel/${id}`)
        .then((res)=>{
            if(res.data.status === "Success")
    ...
    return(
        <div>
            <h2 className='d-flex justify-content-center fs-1 mt-5 mb-5 textstyle fw-bold fs-5 d-flex'>Data Artikel</h2>
